...
/home/webadm/letsencrypt/letsencrypt-auto certonly --webroot -d <%= @fqdn %> --webroot-path /usr/share/nginx/html/ --email simoom634@yahoo.co.jp --agree-tos --renew-by-default
