...
describe file('/etc/nginx/sites-available/gcal') do
  ...
  it { should match_md5checksum 'c0a89bfe5e76b3cb9cde59515d2cbd51' }
end
...
describe file('/etc/init.d/webapp_calendar') do
  ...
  it { should match_md5checksum '8c8dd37c77a760a572a78bcc1e5b0add' }
end
...
describe file('/etc/logrotate.d/gcal') do
  ...
  it { should match_md5checksum 'e7483915a9ec1fec5e8c9c80952cbda0' }
end
